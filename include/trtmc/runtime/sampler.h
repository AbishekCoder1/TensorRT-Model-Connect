...
// ISampler: token selection abstraction for autoregressive generation.
//
...
//
// LogitsLocation tells the pipeline whether to D2H transfer logits before
...
class ISampler {
  public:
    ...
    virtual LogitsLocation logits_location() const = 0;
