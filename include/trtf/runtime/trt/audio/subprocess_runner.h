...
inline RuntimePromptTokenizationResult TokenizeSpeechPromptRuntime(
    ...
    ISubprocessRunner& subprocess_runner)
{
    ...
    result.rc = subprocess_runner.run(
        argv, nullptr, 0, stdout_data, result.stderr_data);
