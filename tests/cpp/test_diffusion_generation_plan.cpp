...
// Intent:         Diffusion generation plan: FLUX/Wan layout derivation and scheduler mode
// selection Preconditions:  Diffusion config with valid latent dimensions Postconditions: Layout
// dimensions and scheduler parameters match expected values
// =============================================================================
