...
static void test_mamba_pipeline() {
    ...
    trtf::RecurrentPipeline pipeline(std::move(module), std::move(rs), cfg, stream,
                                     "MambaPipeline");
...
static void test_hybrid_pipeline() {
    ...
    auto builder = trtf::TrtUniquePtr<nvinfer1::IBuilder>(nvinfer1::createInferBuilder(g_logger));
    auto network = trtf::TrtUniquePtr<nvinfer1::INetworkDefinition>(builder->createNetworkV2(0));
    auto bconfig = trtf::TrtUniquePtr<nvinfer1::IBuilderConfig>(builder->createBuilderConfig());
    ...
    trtf::RecurrentPipeline pipeline(std::move(module), std::move(hybrid), cfg, stream,
                                     "HybridPipeline");
