...
void test_magpie_decoder_plan_enables_cfg_and_gpu_greedy()
{
    ...
    check(plan.use_gpu_greedy, "magpie decoder plan enables gpu greedy when kernels and greedy mode are on");
    check(plan.use_cross_attn_tracking, "magpie decoder plan enables cross-attention tracking when output exists");
