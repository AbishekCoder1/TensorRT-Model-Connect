...
inline void add_temporal_text_embedding(
...
inline void add_temporal_audio_embedding(
    const SpeechConfig& cfg,
    int32_t hidden_size,
...
inline void compute_dual_stream_summed_embed(
    const SpeechConfig& cfg,
    int32_t hidden_size,
    int32_t stream_cb,
...
inline void append_hidden_from_logits(
...
inline void fill_hidden_from_logits(
