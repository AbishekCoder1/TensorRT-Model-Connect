...
inline int32_t compute_whisper_actual_encoder_length(
    int32_t mel_length,
    int32_t mel_full,
    int32_t enc_full)
{
...
inline std::vector<float> build_whisper_padded_mel_input(
    ...
    int32_t expected_length)
{
    ...
    {
        std::memcpy(
            padded.data() + static_cast<std::size_t>(bin) * static_cast<std::size_t>(expected_length),
