...
inline std::size_t delay_cache_index(
...
inline DelayCacheState make_delay_cache_state(
    const std::vector<int32_t>& configured_delays,
...
inline void write_user_tokens_to_delay_cache(
...
inline void fill_initial_delay_tokens(
    DelayCacheState& delay_state,
    int32_t offset,
    int32_t text_bos,
    int32_t audio_bos)
...
inline void seed_delay_offset_zero(
    DelayCacheState& delay_state,
    int32_t text_bos,
    int32_t audio_bos)
{
...
inline void read_model_inputs_from_delay_cache(
...
inline void build_target_audio_arrays(
    const DelayCacheState& delay_state,
    int32_t target_pos,
    int32_t num_cb,
    int32_t audio_bos,
...
inline void clear_provided_flags_at_pos(
    DelayCacheState& delay_state,
    int32_t pos)
{
    for (int32_t k = 0; k < delay_state.total_k; ++k)
...
inline void write_generated_tokens_to_delay_cache(
    DelayCacheState& delay_state,
    int32_t target_pos,
...
inline bool collect_output_codes_from_delay_cache(
    const DelayCacheState& delay_state,
    int32_t offset,
    int32_t max_delay,
    int32_t mimi_cb,
