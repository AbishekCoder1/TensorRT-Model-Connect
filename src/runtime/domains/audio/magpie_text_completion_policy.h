...
inline bool update_magpie_text_consumed_from_cross_attn(
    const float* xattn,
    int32_t text_length,
    int32_t threshold,
    int32_t& max_peak_pos,
...
inline bool update_magpie_text_consumed_from_heuristic(
...
inline bool advance_magpie_finished_limit(
    bool text_consumed,
    int32_t finished_limit,
