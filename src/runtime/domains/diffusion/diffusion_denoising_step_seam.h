...
bool run_flux_denoising_steps(int32_t num_inference_steps, const std::vector<float>& step_timesteps,
    ...
    double total_temb_ms = 0, total_prep_ms = 0, total_dit_ms = 0;
    double total_unpack_ms = 0, total_sched_ms = 0, total_log_ms = 0;
...
bool run_wan_denoising_steps(int32_t num_inference_steps, const std::vector<float>& step_timesteps,
