...
bool StandardTrtModelDefinitionPopulator::can_populate(const DecoderModel& model) const
{
    return model.checkpoint.has_decoder_layers && !model.checkpoint.decoder_layers.empty();
}

bool StandardTrtModelDefinitionPopulator::populate(TrtDecoderDefinition& definition,
