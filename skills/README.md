...
| [gitlab-ai-staging-autopilot](gitlab-ai-staging-autopilot/SKILL.md) | Autonomous ai-staging MR queue — rebase green AI MRs, resolve conflicts target-wins, merge by exact SHA |
| [ai-staging-operator](ai-staging-operator/SKILL.md) | One bounded /loop-safe cycle for the complete AI staging system |
| [ai-task-discovery](ai-task-discovery/SKILL.md) | Discover atomic, verifiable AI cleanup tasks and publish them as GitLab issues |
...
| [ai-sanity-babysitter](ai-sanity-babysitter/SKILL.md) | Repair AI-generated MRs until the ai-staging sanity pipeline is green |
| [ai-staging-babysitter](ai-staging-babysitter/SKILL.md) | Keep ai-staging synced with master, full-CI green, and promotion-ready |
