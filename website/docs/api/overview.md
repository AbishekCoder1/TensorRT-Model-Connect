...
The command-line interfaces are thin adapters over these APIs:

- `trtmc-build` is implemented in `tensorrt_model_connect/tensorrt_model_connect/cli.py`.
- `trtmc` is implemented in `examples/trtmc_cli.cpp`.
