...
class PixArtTorchTrtPlugin:
    ...
    def build_components(
        ...
        *,
        ...
        print("[ttrt-build] Loading T5 text encoder (on CPU) ...",
              file=sys.stderr)
        ...
        print(f"[ttrt-build] Compiling T5 encoder "
        ...
        print(f"[ttrt-build] Loading PixArt DiT "
        ...
        print(f"[ttrt-build] Compiling DiT denoiser "
        ...
        print("[ttrt-build] Loading VAE decoder ...", file=sys.stderr)
        ...
        print(f"[ttrt-build] Compiling VAE decoder "
