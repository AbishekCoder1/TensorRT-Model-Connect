...
class Qwen3OmniPlugin:
    ...
    def build_engine(
        ...
        if verbose:
            print(f"[trtf-build] Building Qwen3-Omni Thinker MoE engine "
...
def _build_audio_encoder_engine(
    ...
    if verbose:
        print(f"[trtf-build] Building Qwen3-Omni audio encoder "
...
def _build_talker_engine(
    ...
    if verbose:
        print(f"[trtf-build]   Talker: layers={num_layers}, "
    ...
    try:
        ...
        print(f"[trtf-build]   Warning: Talker engine build failed: {e}",
              file=sys.stderr)
        return None
...
def _build_code2wav_engine(
    ...
    if verbose:
        print(f"[trtf-build] Building Qwen3-Omni Code2Wav engine "
