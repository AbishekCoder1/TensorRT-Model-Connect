...
def build_qwen_vl_vision_engine(
    ...
    *,
    ...
    if verbose:
        print(f"[trtf-build] Vision: image={fixed_image_size}, "
    ...
    if verbose:
        print(f"[trtf-build] Vision RoPE: head_dim={embed_dim // num_heads}, "
    ...
    # ---------------------------------------------------------------
    if verbose:
        print(f"[trtf-build] Building Qwen VL vision TRT engine "
...
def build_qwen3_vl_vision_engine(
    ...
    *,
    ...
    if verbose:
        print(f"[trtf-build] Qwen3-VL Vision: image={fixed_image_size}, "
    ...
    # ---------------------------------------------------------------
    if verbose:
        print(f"[trtf-build] Building Qwen3-VL vision TRT engine "
              f"({num_layers} layers, embed={embed_dim}, "
              f"patches={num_patches}, merged={num_merged}, "
